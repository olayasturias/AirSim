...
#ifndef msr_airlib_SidescanSonarSimpleParams_hpp
#define msr_airlib_SidescanSonarSimpleParams_hpp
...
namespace airlib
{
    ...
    struct SidescanSonarSimpleParams
    {

        // Velodyne VLP-16 Puck config
        // https://velodyneSidescanSonar.com/vlp-16.html
        ...
        void initializeFromSettings(const AirSimSettings::SidescanSonarSetting& settings)
        {
            ...
            // By default, for multirotors the SidescanSonars FOV point downwards;
            // for cars, the SidescanSonars FOV is more forward facing.
