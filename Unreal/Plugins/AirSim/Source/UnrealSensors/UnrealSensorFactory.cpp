...
#include "UnrealSensors/UnrealSidescanSonarSensor.h"
    ...
    const AirSimSettings::SensorSetting* sensor_setting) const
{
    ...
    case SensorBase::SensorType::SidescanSonar:
        return std::shared_ptr<UnrealSidescanSonarSensor>(new UnrealSidescanSonarSensor(
            *static_cast<const AirSimSettings::SidescanSonarSetting*>(sensor_setting), actor_, ned_transform_));
    default:
